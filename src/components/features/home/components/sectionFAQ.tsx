        ...
        <section className="px-6 py-20 bg-white text-center">
            ...
            <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="text-gray-600 mb-6 text-md">
                    If you still have questions or need more details, we’re here to help! Reach out to us, and we’ll be
                    happy to assist you on your ThinkStorm journey. Whether you&apos;re curious about features, need
