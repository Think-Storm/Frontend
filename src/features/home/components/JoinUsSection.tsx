    ...
    >
        ...
        <div className="flex flex-row gap-5">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">
              Who can join ThinkStorm?
            </h2>
            <p className="text-base md:text-lg text-gray-300 leading-relaxed">
              ThinkStorm is open to all tech professionals, freelancers,
              developers, designers, PMs, and learners eager to collaborate and
              innovate together.
            </p>
          </motion.div>
          ...
          >
            <Button
              variant="highlight"
              size="lg"
              className="px-10 py-6 text-lg cursor-default"
            >
              Join!
            </Button>
          </motion.div>
      ...
      >
        ...
        >
          ...
          <br />
          education, open-source initiatives, and{' '}
