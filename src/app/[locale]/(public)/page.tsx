...
export default function Landing() {
  ...
  return (
    <div>
      ...
      <section className="pt-[64px] relative isolate z-[50] min-h-[900px] flex items-center justify-center overflow-visible">
        ...
        <motion.div
          ...
          style={{
            y: useTransform(
              scrollY,
              [0, scrollLimits.section2Start],
              [0, scrollLimits.maxY]
            ),
            scale: useTransform(
              scrollY,
              [0, scrollLimits.section2Start],
              [1, scrollLimits.maxScale]
            ),
        ...
        >
          ...
          >
            The leading collaboration platform to grow your career and shape
            your future.
          </motion.p>
        ...
        >
          ...
          <div className="order-last lg:order-none max-w-2xl space-y-8">
            ...
            <h3 className="text-3xl md:text-4xl font-bold">
              Create inspiring projects for education, open-source initiatives,
              or profit-driven purposes.
            </h3>
            <p className="text-gray-700 text-md">
              ThinkStorm is the premier platform for creating projects with
              millions of developers worldwide, learning new programming
              languages, and innovating to inspire by building the world of
              tomorrow.
            </p>
            <ul className="text-gray-700 space-y-2 text-sm md:text-md">
      ...
      {/* Section3 */}
      <FadeInWhenVisible>
        <section className="px-6 pt-20 bg-white flex flex-col lg:flex-row gap-14 items-center justify-center mt-20">
          {/* Left Side */}
          <FadeInWhenVisible delay={0.1}>
            <div className="lg:w-full space-y-8 lg:max-w-[450px] max-w-2xl">
              <h2 className="text-sm font-semibold text-gray-600">Services</h2>
              <h3 className="text-3xl md:text-4xl font-bold">
                It’s always hard to start from scratch on your own
              </h3>
              <p className="text-gray-700 text-md">
                Have you watched the entire YouTube tutorial for the programming
                languages you want to learn? Are you feeling frustrated with the
                meaningless projects you’ve completed?
              </p>
              <GradientButton>Coming Soon!</GradientButton>
            </div>
          </FadeInWhenVisible>
          {/* Right Side Cards */}
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-16 lg:max-w-[600px] max-w-2xl">
